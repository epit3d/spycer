...
if __name__ == "__main__":
    ...
    def open_project(project_path: Path | str):
        project_path = Path(project_path)
        load_settings(project_path / "settings.yaml")
        ...
        stlpath = project_path / sett().slicing.stl_file
        if stlpath.is_file():
    ...
    def create_project(project_path: Path | str):
        project_path = Path(project_path)
