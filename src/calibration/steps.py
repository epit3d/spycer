...
class StepsCollection:
    def __init__(self, printer):
        ...
        self.oneFixture = True
        if self.oneFixture:
            self.printer.settings.fixture2.height = self.printer.settings.fixture1.height
            stepClasses = (
                OneFixtureStep1, OneFixtureStep2, OneFixtureFinalStep)
        else:
...
class OneFixtureStep1(Step):
    textRu = (
        ...
        '</p>'
        '<p>'
        'Подсоедините провод калибровочного модуля к разъему на площадке'
        ' крепления печатающей головки.'
        '</p>'
        '<p>'
        'Установите на рабочий стол калибровочную оснастку,'
        ' поставляемую в комплекте с 3Д принтером.'
        '</p>'
        '<p>'
        'Установите перемычку, соединияющую калибровочную оснастку'
        ' и рабочий стол.'
        '</p>'
        '<p>'
        'После нажатия кнопки <b>Далее</b> 3Д принтер начнёт выполнять'
...
class OneFixtureStep2(Step3):
    textRu = (
        ...
        '</p>'
        '<p>'
        'Отсоедините провод калибровочного модуля от разъема на площадке'
        ' крепления печатающей головки.'
        '</p>'
        '<p>'
        'Демонтируйте специальный калибровочный модуль и установите на место'
        ...
        '</p>'
        '<p>'
        'Подсоедините калибровочный провод к калибровочной оснастке'
        ' и разъему на площадке крепления печатающей головки.'
        '</p>'
        '<p>'
        'После нажатия кнопки <b>Далее</b> 3Д принтер начнёт выполнять'
        ' последовательность движений для сбора калибровочных данных.'
...
class OneFixtureFinalStep(FinalStep):
    textRu = (
        ...
        '</p>'
        '<p>'
        'Отсоедините калибровочный провод от калибровочной оснастки'
        ' и разъема на площадке крепления печатающей головки.'
        '</p>'
        '<p>'
        'Демонтируйте с рабочего стола калибровочную оснастку.'
        '</p>'
        '<p>'
        'После нажатия кнопки <b>Завершить</b> будет создан новый'
        ' калибровочный файл для этого 3Д принтера.'
