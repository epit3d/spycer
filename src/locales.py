...
class Locale:
    ...
    NamePlanes = "Name"
    PrintTime = "Approximate print time, minutes: "
    ConsumptionMaterial = "Approximate consumption of material, mm: "
...
dicts = {
    ...
    "ru": Locale(
        ...
        NamePlanes = "Название",
        PrintTime = "Примерное время печати, минуты: ",
        ConsumptionMaterial = "Примерный расход материала, мм: ",
    ),
}
